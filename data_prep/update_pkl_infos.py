...
from convert_utils import (convert_annos, get_kitti_style_2d_boxes)
...
def update_waymo_infos(pkl_path, out_dir):
    ...
    data_list = pickle.load(pkl_path)
    print('Start updating:')
    converted_list = []
    for ori_info_dict in data_list:
    ...
    pickle.dump(converted_data_info, out_path, 'pkl')
