...
from structures import Box3DMode, CameraInstance3DBoxes, points_cam2img
import box_np_ops


waymo_categories = ('Car', 'Pedestrian', 'Cyclist', 'Sign')

#from https://github.com/nutonomy/nuscenes-devkit
